...
//create xml file
	...
	foreach ($resArray as $res) {
    	...
    	//create attribute
    	$id = $doc->createAttribute("id");/*This function creates a new instance of class DOMAttr.
    	This node will not show up in the document unless it is inserted with DMONode::appendChild().*/
